...
import CAR_CONTACT_PHONE from '@salesforce/schema/Car__c.Contact__r.Phone';
import CAR_TYPE_NAME from '@salesforce/schema/Car__c.Car_Type__r.Name';

const fields = [CAR_ID,CAR_NAME,CAR_MILEAGE,
    CAR_PER_DAY_RENT,CAR_BUILD_YEAR,CAR_PICTURE,
    CAR_CONTACT_NAME,CAR_CONTACT_EMAIL,CAR_CONTACT_PHONE,
    CAR_TYPE_NAME];
...
export default class CarDetails extends LightningElement {
    ...
    connectedCallback(){
        ...
        console.log('connectedCallback ended' + this.car.data);
    };

    callBackMethod(payload){
        this.carId = payload;
        console.log(' payload in carDetail.js::' + payload);
    };
